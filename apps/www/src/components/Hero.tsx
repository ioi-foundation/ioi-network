import { FadeIn, IOI_APPS, Stagger } from "@ioi/ui";
        ...
        >
          ...
          >
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              <a
                href="#"
                className="px-6 py-2.5 rounded-lg bg-white text-zinc-900 font-medium border border-zinc-300 hover:bg-zinc-100 transition-colors"
              >
                See Documentation
              </a>
              <a
                href="#"
                className="px-6 py-2.5 rounded-lg bg-blue-600 text-white font-medium hover:bg-blue-500 transition-colors inline-flex items-center gap-2"
              >
                Launch Hub →
              </a>
            </div>
