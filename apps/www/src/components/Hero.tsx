    ...
    <div className="relative">
      ...
      <div className="w-screen sm:max-w-full md:max-w-5xl lg:max-w-6xl xl:max-w-7xl 2xl:max-w-[1600px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 relative z-10">
        ...
        >
          ...
          <div
            className="border-r border-b border-white/10 flex flex-col items-center justify-center p-4 sm:p-6 md:p-8 bg-black font-sans min-w-0"
            style={{ gridColumn: '2 / 12', gridRow: '2 / 6' }}
          >
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4 sm:mb-6 text-center leading-[1.2]">
              <span className="block mb-2 sm:mb-3">The Infrastructure for</span>
              <span className="block">Autonomous Agents</span>
            </h1>
            <p className="leading-[1.3] text-base sm:text-lg md:text-xl text-white/60 max-w-xl mx-auto mb-6 sm:mb-10 text-center px-1">
            ...
            <div className="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4 justify-center text-sm sm:text-base font-sans font-medium w-full sm:w-auto">
              <a
