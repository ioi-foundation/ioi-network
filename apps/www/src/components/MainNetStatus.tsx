...
export const MainNetStatus = () => {
  return (
    <div className="w-full pt-16 pb-8 flex justify-center items-center gap-2.5 font-medium font-sans">
      <div className="rounded-[4px] py-0.5 px-1.5 text-sm text-[#0075FF]">Mainnet Beta</div>
